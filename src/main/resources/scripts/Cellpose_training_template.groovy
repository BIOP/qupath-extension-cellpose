...
//                .useTestDir(false)                                // Optional - default true : put false ONLY TO TRAIN OMNIPOSE MODELS
        .cleanTrainingDir()                                         // Optional - Will delete the training directory and re-save image patches. Remove this line to skip re-saving images but... ==> WARNING: TO USE AT YOUR OWN RISK !!!
        .build()
